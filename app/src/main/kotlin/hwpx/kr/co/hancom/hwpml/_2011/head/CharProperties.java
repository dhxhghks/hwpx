 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{http://www.hancom.co.kr/hwpml/2011/head}charPr" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
...
@XmlRootElement(name = "charProperties")
public class CharProperties {

    @XmlElement(required = true)
    protected List<CharPr> charPr;
    @XmlAttribute(name = "itemCnt", required = true)
    protected BigInteger itemCnt;

    /**
     * Gets the value of the charPr property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the charPr property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getCharPr().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<CharPr> getCharPr() {
        if (charPr == null) {
            charPr = new ArrayList<CharPr>();
        }
        return this.charPr;
    }
